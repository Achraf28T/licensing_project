 ...
 */
class getLicenseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LicenseRepository' shared autowired service.
     *
     * @return \App\Repository\LicenseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LicenseRepository.php';

        return $container->privates['App\\Repository\\LicenseRepository'] = new \App\Repository\LicenseRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
