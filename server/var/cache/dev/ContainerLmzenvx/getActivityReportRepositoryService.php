 ...
 */
class getActivityReportRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ActivityReportRepository' shared autowired service.
     *
     * @return \App\Repository\ActivityReportRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ActivityReportRepository.php';

        return $container->privates['App\\Repository\\ActivityReportRepository'] = new \App\Repository\ActivityReportRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
