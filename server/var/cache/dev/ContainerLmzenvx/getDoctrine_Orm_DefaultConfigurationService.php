...
class getDoctrine_Orm_DefaultConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\ActivityReportRepository' => ['privates', 'App\\Repository\\ActivityReportRepository', 'getActivityReportRepositoryService', true],
            'App\\Repository\\LicenseRepository' => ['privates', 'App\\Repository\\LicenseRepository', 'getLicenseRepositoryService', true],
            'App\\Repository\\MachineActivationRepository' => ['privates', 'App\\Repository\\MachineActivationRepository', 'getMachineActivationRepositoryService', true],
        ], [
            'App\\Repository\\ActivityReportRepository' => '?',
            'App\\Repository\\LicenseRepository' => '?',
            'App\\Repository\\MachineActivationRepository' => '?',
        ])));
