 ...
 */
class getMachineActivationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MachineActivationRepository' shared autowired service.
     *
     * @return \App\Repository\MachineActivationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MachineActivationRepository.php';

        return $container->privates['App\\Repository\\MachineActivationRepository'] = new \App\Repository\MachineActivationRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
